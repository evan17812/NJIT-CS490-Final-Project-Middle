...
function populateQDB(response){
	...
	for (var i in questionDB){
		...
		add_td.innerHTML = '<div class="text-center" ><input type="button" value="Add" onClick="addQuestion('+(q)+')" id="question_to_add_'+i+'"></div>'
		} else {
			var flag = false;
			...
			if (flag == true) {
			add_td.innerHTML = '<div class="text-center" ><input type="button" disabled value="Add" onClick="addQuestion('+(q)+')" id="question_to_add_'+i+'"></div>'
			} else {
			add_td.innerHTML = '<div class="text-center" ><input type="button" value="Add" onClick="addQuestion('+(q)+')" id="question_to_add_'+i+'"></div>'
			}
		}
...
function ajaxCallQuestionDB(){
	var data = 'json_string={"header":"getQuestionBank"}';
	console.log(data);
