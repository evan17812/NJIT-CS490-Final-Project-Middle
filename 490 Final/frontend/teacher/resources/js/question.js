...
function submitQuestion(){
	...
	var array = '{"header":"addQuestion","functionName":"'+func_name+'", "question":"'+question_text+'", "topic":"'+topic+'", "difficulty":"'+difficulty+'", "parameters":"'+param_names+'", "input":"'+input_cases+'", "output":"'+output_cases+'"}';
